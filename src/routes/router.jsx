...
import Classdetails from "../pages/Instructors/Classdetails";
import Doubts from "../pages/Instructors/Doubts";
import Classdetails1 from "../pages/Instructors/Classdetails1";
import Classdetails2 from "../pages/Instructors/Classdetails2";
...
export const router = createBrowserRouter([
    {
      ...
      },
      {
        path:"/class/:id",
        element:<SingleClass/>,
        loader:({params})=>fetch(`https://threadmastery.onrender.com/class/${params.id}`)
      },
      {
        path:"/classdetails",
      ...
      {
        path:"/classdetails1",
        element:<Classdetails1/>
      },
      {
        path:"/classdetails2",
        element:<Classdetails2/>
      },
      {
        path:"/joinclass",
        element:<Doubts/>
    ...
    },
    {
      ...
      },
      {
        path:"update-user/:id",
        element:<UpdateUser/>,
        loader:({params})=>fetch(`https://threadmastery.onrender.com/users/${params.id}`)
      }
    ]
    }
  ]);
