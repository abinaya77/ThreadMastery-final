  ...
  return (
    <div>
      <div className='my-6 text-center'>
        <h1 className='text-4xl font-bold'>My <span className='text-secondary'>Selected</span> Product</h1>
      </div>
            ...
            <div className='md:w-3/4'>
              <div className='bg-white rounded-lg shadow-md p-6 mb-4'>
                <table className='w-full'>
                  ...
                  <tbody>
                    {
                      classes.length === 0 ? <tr> <td colSpan='5' className='text-center text-2xl font-bold'> No Products Found</td></tr> :
