...
const MyClasses = () => {
  ...
  return (
    <div>
       <div className='my-10'>
        <h1 className='text-4xl font-bold text-center'> My Products</h1>
        <p className='text-[12px] text-center my-2'>here you can see all your Products and reviews</p>
       </div>
       {/**card */}
       <div>
        {
            classes.length===0 ? <div className='text-2xl font-bold text-center mt-10'>you dont have any Products yet!</div> :<div>
                {
                                  ...
                                  {/** Some Info */}
                                    <div className='w-1/3 pr-4'>
                                      <div>
                                          ...
                                          <h1 className='text-secondary'><span className='text-black'>Total Purchased :</span> {cls.totalEnrolled ? cls.totalEnrolled : 0}</h1>
                                          <h1 className='text-secondary'><span className='text-black'>Available Quantity :</span> {cls.availableSeats}</h1>
