...
const NavBar = () => {
  ...
  return (
    ...
    >
      <div className='lg:w-[95%] mx-auto sm:px-6 lg:px-6 text-black dark:text-white'>
        <div className='px-4 py-4 flex items-center justify-between'>
          ...
          <div onClick={() => navigate('/')} className='flex-shrink-0 cursor-pointer pl-2 md:p-0 flex items-center'>
            <div className='footer-img flex gap-2 items-center'>
              <img src='/logo5.png' alt='logo' className='w-8 h-8' />
              <div>
                <h1 className='text-2xl inline-flex gap-3 items-center font-bold'>MayurFashions </h1>
                <p className='font-bold text-[13px] tracking-[3px]'>Wear Art With Aari</p>
              </div>
            </div>
          </div>
