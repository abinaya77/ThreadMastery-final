...
const Login = () => {
  ...
  return (
    <div className='mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8'>
        ...
        <p className='mx-auto mt-4 max-w-md text-center text-gray-500'>Explore our comprehensive products & courses,meticulously crafted to cater to all levels of expertise</p>
            ...
            <form  onSubmit={handleSubmit} className='space-y-4'>
                ...
                <div>
                    ...
                    <div className='relative'>
                        ...
                        outline-none rounded-lg borger-gray-200 p-4 pe-12 text-sm shadow-sm'/>
                        <span className='absolute inset-y-0 end-0 grid place-content-center
                        px-4'><MdOutlineAlternateEmail className='h-4 w-4 text-gray-400'/></span>
                ...
                <div>
                    ...
                    <div className='relative'>
                        <input type={showPassword?'text':'password'} name='password' placeholder='enter password' className='w-full border
                        outline-none rounded-lg borger-gray-200 p-4 pe-12 text-sm shadow-sm'/>
                        <span  onClick={()=>setshowPassword(!showPassword)}className='absolute inset-y-0 end-0 grid place-content-center
                        px-4'><MdOutlineRemoveRedEye className='h-4 w-4 text-gray-400'/></span>
                    </div> 
                </div>
