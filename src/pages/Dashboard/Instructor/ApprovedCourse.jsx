...
const ApprovedCourse = () => {
  const [classes, setClasses] = useState([]);
    ...
    return (
        <div>
            <div className='my-10'>
                <h1 className='text-4xl font-bold text-center'> My Approved Products</h1>
                <p className='text-[12px] text-center my-2'>Here you can see all your products and reviews</p>
            </div>
            <div>
                {
                    classes.length === 0 ? (
                        <div className='text-2xl font-bold text-center mt-10'>You don't have any approved products!</div>
                    ) : (
