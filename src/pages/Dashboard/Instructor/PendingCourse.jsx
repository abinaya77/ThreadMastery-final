...
const PendingCourse = () => {
  const [classes, setClasses] = useState([]);
    ...
    return (
        <div>
            <div className='my-10'>
                <h1 className='text-4xl font-bold text-center'> My Pending Products</h1>
                <p className='text-[12px] text-center my-2'>Here you can see all your pending Products and reviews</p>
            </div>
            <div>
                {
                    classes.length === 0 ? (
                        <div className='text-2xl font-bold text-center mt-10'>You don't have any pending Products!</div>
                    ) : (
                                        ...
                                        <div className='flex flex-wrap justify-between'>
                                            <div className='w-1/3 pr-4'>
                                                <div>
                                                    ...
                                                    <h1 className='text-secondary'><span className='text-black'>Availble Quantity :</span> {cls.availableSeats}</h1>
