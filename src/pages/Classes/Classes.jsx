  ...
  return (
    <div>
      <div className='mt-20 pt-3'>
        <h1 className='text-4xl font-bold text-center text-secondary'>Products</h1>
        <p className='text-center '>These are our variety of affordable unstitched aari blouses</p>
      </div>
          ...
          >
            ...
            <div className='px-6 py-2'>
              ...
              <div className='flex items-center justify-between mt-2'>
                <span className='text-gray-600 text-xs'>Available Products: {cls.availableSeats}</span>
                <span className='text-green-500 font-semibold'>${cls.price}</span>
              </div>
              <p className='text-gray-500 text-xs mt-3'>Total Quantity: 1 </p>
