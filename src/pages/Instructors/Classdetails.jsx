            ...
            <div className='container'>
                <div className='grid grid-cols-12 md:gap-[30px]'>
                    ...
                    <div className='bg-[#F8F8F8] dark:bg-indigo-500 space-y-6 p-8 rounded-md my-8'>
                        <h4 className='text-2xl'>This is a beginner friendly course!!!</h4>
                    </div>
                        ...
                        <div className='new-tab-wrapper mt-12'>
                            <h1 className='text-bold text-3xl'>Level-1 Stitches</h1>
                            <ul id="tabs-nav" className='course-tab mb-8'>
                                <li className='active'>
                                    <a href="#tab1">Chain stitch</a>
                                </li>
                                <li>
                                    <a href="#tab2">ZigZag</a>
                                </li>
                                <li>
                                    <a href="#tab3">Meter Chain</a>
                                </li>
                                <li>
                                    <a href="#tab4">Rope</a>
                                </li>
                                ...
                                <li>
                                    <a href="#tab6">Butterfly stitch</a>
                                </li>
                                <li>
                                    <a href="#tab7">Khatta stitch</a>
                                </li>
                                <li>
                                    <a href="#tab8">Bullion stitch</a>
                                </li>
                                <li>
                                    <a href="#tab9">Button Hole</a>
                                </li>
                                <li>
                                    <a href="#tab10">Double button hole</a>
                                </li>
                                <li>
                                    <a href="#tab11">Stripped button hole</a>
                                </li>
                                <li>
                                    <a href="#tab12">Feather stitch</a>
                                </li>
                                <li>
                                    <a href="#tab13">Kashmir work</a>
                                </li>
                                <li>
                                    <a href="#tab14">Mango stitch</a>
                                </li>
                                <li>
                                    <a href="#tab15">Load Flower</a>
                                </li>
                                <li>
                                    <a href="#tab16">Thambul work</a>
                                </li>
                                <li>
                                    <a href="#tab17">Long and short stitch</a>
                                </li>
                                <li>
                                    <a href="#tab18">water filling stitch</a>
                                </li>
                                <li>
                                    <a href="#tab19">Stripped different leaf</a>
                                </li>
                                <li>
                                    <a href="#tab20">Chamki work</a>
                                </li>
                                <li>
                                    <a href="#tab21">Sugar bead</a>
                                </li>
                                <li>
                                    <a href="#tab22">Kardhana stitch</a>
                                </li>
                            </ul>
                            <div id="tabs-content">
